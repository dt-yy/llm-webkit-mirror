Unique_ID = 'all_ids_pjcc_20300101_921b9a'
...
REMOVE_COMMENTS_XPATH = [
    ...
    or starts-with(@id, 'dsq-comments') or contains(@class, '-comment')
    ]"""
]
...
BODY_XPATH = [
    ...
    contains(@id, "body-text") or contains(@class, "body-text") or contains(@class, "body-content") or
    contains(translate(@class, "B", "b"), "textbody") or
    ...
    or contains(@class, "content__body") or contains(translate(@id, "CM","cm"), "main-content") or
    contains(translate(@class, "CM","cm"), "main-content")
    or contains(translate(@class, "CP","cp"), "page-content") or
    @id="content" or @class="content"])[1]""",
    """(.//*[(self::article or self::div or self::section)][starts-with(@class, "main") or starts-with(@id, "main") or
    starts-with(@role, "main")])[1]|(.//main)[1]""",
]
...
Forum_XPATH = [
    ...
    """.//*[(self::article or self::div or self::main or self::section or self::li or self::tr)][contains(@class, "message-container") or
    contains(@id, "message_container") or contains(@class, "Messages_container")]""",
    """.//*[(self::article or self::div or self::main or self::section or self::p or self::span or self::li or self::tr)][
    contains(@id, 'comment-content') or contains(@class, 'comment-content') or contains(@class, 'comment-body') or
    contains(@class, 'comment-body') or contains(@class, "post-reply") or contains(@class, "reply_content") or
    contains(@class, "reply-content") or contains(@class, "reply_post") or contains(@class, "post-reply") or
    contains(@id, "reply") or contains(@class, "post-text") or contains(@class, "post_text") or
    contains(@class, "post-body") or contains(@class, "postbody") or contains(@class, "post-entry") or
    contains(@class, "postentry") or contains(@component, 'post') or
    contains(@class, "post-content") or contains(@class, "post_content") or
    contains(@class, "p_content") or contains(@class, "Post_content") or contains(@class, "message-post") or contains(@class, "js-post")]""",
    # id 包含post-加数字组成的形式
    """.//*[(self::article or self::div or self::main or self::section or self::p or self::span or self::li or self::tr)][contains(@id, 'post')]"""
]
